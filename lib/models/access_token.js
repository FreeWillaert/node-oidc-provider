...
module.exports = function getAccessToken(provider) {
  ...
  return class AccessToken extends BaseToken {
    ...
    sign(client, options) {
      ...
      // TODO: Is it required to support access tokens that don't expire? Alternatively, should we allow that access tokens don't expire?
      ...
      // TODO: audience must not come directly from request, but first pass validation (provider allowed values and/or client policy and/or user consent).
