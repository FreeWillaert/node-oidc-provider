  ...
  return class AccessToken extends BaseToken {
    ...
    sign(client, options) {
      ...
      const authorizedPromises = [
        authorizeAccessTokenTargetsFunction.call(this, client.clientId, requestedTargets),
        authorizeAccessTokenScopesFunction.call(this, client.clientId, requestedTargets, requestedScopes)
      ];
